...
class DoublePendulum:
    def __init__(self, G, L1, L2, M1, M2, dt, total_t, th1, w1, th2, w2, ax):
        ...
        self.title =  r'$\theta1={}\degree, \omega1={}\degree/s, \theta2={}\degree, \omega2={}\degree/s$'.format(th1, w1, th2, w2)
        ...
        self.line, = self.ax.plot([], [], 'o-', c="#0000FF", lw=2)
        self.inner_trail, = self.ax.plot([], [], c="#B80000", lw=1)
        self.outer_trail, = self.ax.plot([], [], c="#6600FF", lw=1)
    ...
    # referred from http://www.physics.usyd.edu.au/~wheat/dpend_html/solve_dpend.c
...
if __name__ == "__main__":
    ...
    ani = animation.FuncAnimation(fig,
                                  ...
                                  init_func=join_mat_funcs(pend1.init, pend2.init), repeat_delay=3000)
